...
from .ui import input_prompt, panel, UserCancelled 
...
def run_registration_interactive() -> dict:
    ...
    try:
        ...
        email = _ask("Your work email [name@palo-it.com]:", profile.get("email", "jane.doe@palo-it.com"), validator=_email)
        ...
        panel("↩️ Registration cancelled.")
        return None
